...
*2024 – present* · [github.com/theotaburet/Ravitools](https://github.com/theotaburet/Ravitools)

Ravitools enriches GPX files with offline-accessible points of interest — water
sources, restaurants, campsites — aimed at long-distance cyclists who lose signal
where they most need to know where the next tap is.

- Offline POI integration
- Customisable routes
